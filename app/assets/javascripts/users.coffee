...
$(".users.show").ready ->
  ...
  $('#bet_text_field').bind 'change paste keyup', ->
    ...
    if maximumWinningPrice < betTextField + totalBalance && betTextField <= totalBalance
      alert 'Good flipping. You are within range of $250, which is the maximum we will pay out to you, even if you wind up with more in your balance at the end of this experiment. You may want to reconsider your bet, in light of this $250 cap on what we’ll pay out to you. Good luck and happy flipping!'
    return
  setTimeout (->
    waiting = false
    $("#animation").hide(100)
